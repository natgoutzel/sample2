  ...
  <div id="main" class="cf">
    <div class="page-content">
      <div class="entry-content cf">
        <h2  class="heading">Ανακοινώσεις</h2>
        <div class="accordion-trigger">Τίτλος Ανακοίνωσης 1</div>
        <div class="accordion-container"> Ανακοίνωση 1 </div>
        <div class="accordion-trigger">Τίτλος Ανακοίνωσης 2</div>
        <div class="accordion-container"> Ανακοίνωση 2 </div>
        <div class="accordion-trigger">Τίτλος Ανακοίνωσης 3</div>
        <div class="accordion-container"> Ανακοίνωση 3</div>

...
<head>
<title>ΔΙΔΑΚΤΙΚΟ ΠΡΟΣΩΠΙΚΟ</title>
<meta charset="utf-8">
   ...
   <div id="main" class="cf">
    <div class="page-content">
      <div class="entry-content cf">
        ...
        <h2 >Toggle</h2>
        <div class="toggle-trigger"><i></i>ΓΙΩΡΓΟΣ ΠΑΠΑΔΟΠΟΥΛΟΣ</div>
        <div class="toggle-container"> Δάσκαλος </div>
        <div class="toggle-trigger"><i></i>ΜΑΡΙΑ ΠΑΠΑΔΟΠΟΥΛΟΥ</div>
        <div class="toggle-container"> Δασκάλα Αγγλικών </div>
        <div class="toggle-trigger"><i></i>ΓΙΑΝΝΗΣ ΠΑΠΑΔΟΠΟΥΛΟΣ</div>
        <div class="toggle-container"> Γυμναστης </div>
  ...
  <ul  class="widget-cols cf">
    ...
    <li class="second-col">
      <div class="widget-block">
        ...
        <p><a href="actions.php" class="action-button">ΠΕΡΙΣΣΟΤΕΡΑ</a></p>
      </div>
    </li>
